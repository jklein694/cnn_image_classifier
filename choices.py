...
def do_run_all():
    ...
    total_loss, accuracy = cnn4.run(x, y, epochs=epoch_param, learning_rate=learn_param)
...
def do_run_train():
    ...
    # Run convolutional neural network
    total_loss, accuracy = cnn4.run(x, y, epochs=epoch_param, learning_rate=learn_param, image_size=image_size)
